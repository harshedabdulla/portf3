Link :- https://harshedabdulla.github.io/portf3/
...
This is Harshed, my latest, greatest, and quite possibly most unique template for HTML5 UP.
...
Harshed, which combines a robust side-scrolling framework of my own creation (with various
...
Instructions:
	...
	========
		...
		Harshed does two things to work around this:
		...
		Harshed does this in FOUR (!) ways:
		...
		- Scroll Wheel: Harshed modifies* the scroll wheel's behavior to translate vertical
	...
	==============
		...
		Harshed includes span modifiers ranging from 0.25 units ("span-0-25") to 10 units
	...
	==============
		...
		Most of Harshed's elements are pretty much what you'd expect, but there are a handful
		...
		------
			...
			The primary building block of Harshed.
